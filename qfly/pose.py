...
class Pose:
    ...
    def clamp(self, world):
        ...
        """
        self.x = max(
            world.origin.x - world.expanse + world.padding,
            min(self.x, world.origin.x + world.expanse - world.padding),
        )
        self.y = max(
            world.origin.y - world.expanse + world.padding,
            min(self.y, world.origin.y + world.expanse - world.padding),
        )
        self.z = max(
            0, min(self.z, world.origin.z + (2 * world.expanse) - world.padding)
        )
